...
class ViewInstance
{
    ...
    /**
     * @var Directives $directives The custom directives to apply to this instance.
     */
    private $directives;
	 ...
	 * @param string          $path
	 * @param string          $cache
	 * @param Directives|NULL $directives
	 */
    public function __construct(string $path, string $cache, Directives $directives = null)
    {
        $this->path = $path;
        $this->cache = $cache;
     ...
     * @inheritdoc
     */
    public function addExtension(string $extension): ViewInstance
    {
        $this
            ->getViewFactory()
     ...
     * @return $this
     */
    public function extend(callable $compiler): ViewInstance
    {
        $this
            ->getCompiler()
            ->extend($compiler);
     ...
     * @return $this
     */
    public function directive(string $name, callable $handler): ViewInstance
    {
        $this
            ->getCompiler()
     ...
     * @return $this
     */
    public function if(string $name, callable $handler): ViewInstance
    {
     ...
     * @return $this
     */
    public function addPath(string $path): ViewInstance
    {
     ...
     * @return $this
     */
    public function share($key, $value = null): ViewInstance
    {
     ...
     * @return $this
     */
    public function composer($key, $value): ViewInstance
    {
     ...
     * @return $this
     */
    public function creator($key, $value): ViewInstance
    {
     ...
     * @return $this
     */
    public function addNamespace($namespace, $hints): ViewInstance
    {
     ...
     * @return $this
     */
    public function replaceNamespace($namespace, $hints): ViewInstance
    {
